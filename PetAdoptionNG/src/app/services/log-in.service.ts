...
export class LogInService {
  ...
  private headerImgur = new HttpHeaders({
    Authorization: "Client-ID 3c09ec7282cf370",
  });

  //Log in  -- Tested 4/13/2020
  checkAdopter(adop: Adopter): Observable<Adopter> {
    return this.http.post<Adopter>(this.url + "/paduser/login", adop, {
  ...
  addAdopter(adop: Adopter): Observable<Adopter> {
    return this.http.post<Adopter>(this.url + "/paduser", adop, {
      headers: this.headers,
    });
  }
  ...
  allApplication(): Observable<Application[]> {
    ...
    return this.http.get<Application[]>(
      this.url + "/padapplication/find/?appstatus=pending"
    );
  }
  ...
  userApplication(userId: number): Observable<Application[]> {
    return this.http.get<Application[]>(
      this.url + "/padapplication/userid/" + userId
    );
  }
  ...
  deleteAllButApplication(petId: number, userId: number): Observable<Object> {
    ...
    return this.http.delete(this.url + "/padapplication/excluding", {
      params: params,
    });
  }
  ...
  makeApplication(app: Application): Observable<Application> {
    return this.http.post<Application>(this.url + "/padapplication", app, {
      headers: this.headers,
    });
  }
  ...
  updatePet(pet: Pet): Observable<Pet> {
    return this.http.post<Pet>(this.url + "/pet/update", pet, {
      headers: this.headers,
    });
  }
  ...
  createAlbum(petId: number): Observable<Object> {
    ...
    return this.http.post<Object>("https://api.imgur.com/3/album", obj, {
      headers: this.headerImgur,
    });
  }
  ...
  uploadImg(string: any): Observable<Object> {
    return this.http.post<Object>("https://api.imgur.com/3/image/", string, {
      headers: this.headerImgur,
    });
  }

  createPetPic(petpic: PetPic): Observable<PetPic> {
    return this.http.post<PetPic>(this.url + "/petpic", petpic, {
      headers: this.headers,
    });
  }
